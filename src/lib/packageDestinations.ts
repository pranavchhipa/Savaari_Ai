...
const DESTINATIONS: Record<string, CuratedAttraction[]> = {
  ...
  bangalore: [
    { id: 'bangalore-1', name: 'Lalbagh Botanical Garden', type: 'nature', description: 'A 240-acre royal botanical garden with a glass house, an ancient rock, and thousands of plant species.', whyVisit: "Bengaluru's green lung — a perfect morning stroll.", famousFor: 'Glass House & flower shows', rating: 4.5, badges: ['family-friendly'], approximateKm: 4, detourKm: 0, suggestedDuration: 75, bestTimeToVisit: 'morning', lat: 12.9507, lng: 77.5848 },
    { id: 'bangalore-2', name: 'Bangalore Palace', type: 'heritage', description: 'A Tudor-style palace inspired by Windsor Castle, with ornate interiors and royal memorabilia.', whyVisit: 'Royal grandeur in the heart of the city.', famousFor: 'Tudor architecture', rating: 4.3, badges: ['must-visit'], approximateKm: 5, detourKm: 0, suggestedDuration: 75, bestTimeToVisit: 'morning', lat: 12.9988, lng: 77.5921 },
    { id: 'bangalore-3', name: 'Cubbon Park', type: 'nature', description: 'A sprawling landscaped park with shaded avenues, statues and the State Central Library.', whyVisit: 'A leafy escape in the city centre.', famousFor: 'Heritage green space', rating: 4.4, badges: ['family-friendly'], approximateKm: 3, detourKm: 0, suggestedDuration: 60, bestTimeToVisit: 'morning', lat: 12.9763, lng: 77.5929 },
    { id: 'bangalore-4', name: 'Vidhana Soudha', type: 'heritage', description: "The grand granite seat of Karnataka's legislature — floodlit and majestic in the evenings.", whyVisit: "Bengaluru's most iconic landmark.", famousFor: 'Neo-Dravidian architecture', rating: 4.5, badges: ['instagram-worthy'], approximateKm: 4, detourKm: 0, suggestedDuration: 30, bestTimeToVisit: 'evening', lat: 12.9794, lng: 77.5907 },
    { id: 'bangalore-5', name: 'ISKCON Temple Bangalore', type: 'cultural', description: 'A vast hilltop Krishna temple complex blending modern and traditional temple architecture.', whyVisit: 'Serene, grand and beautifully lit.', famousFor: 'Krishna worship', rating: 4.6, badges: ['must-visit'], approximateKm: 8, detourKm: 0, suggestedDuration: 60, bestTimeToVisit: 'morning', lat: 13.0098, lng: 77.5510 },
    { id: 'bangalore-6', name: "Tipu Sultan's Summer Palace", type: 'heritage', description: 'An elegant teak palace of the Tiger of Mysore, adorned with frescoes and carved arches.', whyVisit: 'A quiet slice of Mysore-era history.', famousFor: 'Teakwood palace', rating: 4.2, badges: ['hidden-gem'], approximateKm: 5, detourKm: 0, suggestedDuration: 40, bestTimeToVisit: 'morning', lat: 12.9591, lng: 77.5739 },
    { id: 'bangalore-7', name: 'Bannerghatta Biological Park', type: 'nature', description: 'A zoo, butterfly park and jeep safari with lions, tigers and bears just outside the city.', whyVisit: 'Big-cat safari — kids love it.', famousFor: 'Wildlife safari', rating: 4.3, badges: ['family-friendly'], approximateKm: 22, detourKm: 0, suggestedDuration: 150, bestTimeToVisit: 'morning', lat: 12.8000, lng: 77.5770 },
    { id: 'bangalore-8', name: 'Bull Temple', type: 'cultural', description: 'A 16th-century temple housing a giant monolithic Nandi bull carved from a single granite boulder.', whyVisit: "One of Bengaluru's oldest shrines.", famousFor: 'Monolithic Nandi', rating: 4.4, badges: ['hidden-gem'], approximateKm: 6, detourKm: 0, suggestedDuration: 30, bestTimeToVisit: 'morning', lat: 12.9430, lng: 77.5650 },
    { id: 'bangalore-9', name: 'Nandi Hills', type: 'viewpoint', description: 'A misty hill fortress famed for spectacular sunrises above a sea of clouds, an hour from the city.', whyVisit: "The region's best sunrise/sunset point.", famousFor: 'Sunrise viewpoint', rating: 4.5, badges: ['must-visit', 'instagram-worthy'], approximateKm: 60, detourKm: 0, suggestedDuration: 120, bestTimeToVisit: 'morning', lat: 13.3702, lng: 77.6835 },
    { id: 'bangalore-10', name: 'Commercial Street & UB City', type: 'cultural', description: "Buzzing shopping lanes and a luxury mall — Bengaluru's retail and cafe heart.", whyVisit: 'Shopping, food and people-watching.', famousFor: 'Shopping & dining', rating: 4.2, badges: ['family-friendly'], approximateKm: 4, detourKm: 0, suggestedDuration: 90, bestTimeToVisit: 'evening', lat: 12.9830, lng: 77.6090 },
  ],
  enroute: [
    { id: 'enroute-1', name: 'Ramanagara', type: 'nature', description: 'The dramatic granite hills where the classic film Sholay was shot — a rock-climbing and vulture haven.', whyVisit: 'Stand where Bollywood history was made.', famousFor: 'Sholay rocks', rating: 4.2, badges: ['instagram-worthy'], approximateKm: 50, detourKm: 2, suggestedDuration: 40, bestTimeToVisit: 'morning', lat: 12.7110, lng: 77.2810 },
    { id: 'enroute-2', name: 'Channapatna Toy Town', type: 'cultural', description: 'The "toy town" of Karnataka, famed for handcrafted lacquered wooden toys made for generations.', whyVisit: 'Watch artisans craft colourful toys.', famousFor: 'Wooden lacquer toys', rating: 4.1, badges: ['family-friendly'], approximateKm: 60, detourKm: 1, suggestedDuration: 45, bestTimeToVisit: 'morning', lat: 12.6510, lng: 77.2070 },
    { id: 'enroute-3', name: 'Srirangapatna', type: 'heritage', description: "Tipu Sultan's island-fortress capital — fort, the Daria Daulat summer palace and Ranganathaswamy temple.", whyVisit: 'A fortress that shaped South Indian history.', famousFor: "Tipu Sultan's fort", rating: 4.6, badges: ['must-visit'], approximateKm: 125, detourKm: 3, suggestedDuration: 75, bestTimeToVisit: 'morning', lat: 12.4180, lng: 76.6940 },
  ],
};
